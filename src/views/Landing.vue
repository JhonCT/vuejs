            ...
            <section class="section-shaped my-0">
                ...
                <div class="container shape-container d-flex">
                    <div class="col px-0">
                        <div class="row">
                            <div class="col-lg-6">
                                <h1 class="display-3  text-white">Impacto Wi-Fi                                    
                                </h1>
                                <p class="lead  text-white">Navega por internet con una alta velocidad de conexión desde tu hogar</p>
                        ...
                        <div class="row row-grid">
                            <div class="col-lg-4">
                                <card class="border-0" hover shadow body-classes="py-5">
                                    ...
                                    <h6 class="text-primary text-uppercase">Plan 40</h6>
                                    <p class="description mt-3">Navega con una velocidad de 2 Mbps por la red.</p>
                                    <div>
                                        <badge type="primary" rounded>velocidad</badge>
                                        <badge type="primary" rounded>seguridad</badge>
                                        <badge type="primary" rounded>disponibilidad</badge>
                                    </div>
                            ...
                            <div class="col-lg-4">
                                <card class="border-0" hover shadow body-classes="py-5">
                                    ...
                                    <h6 class="text-success text-uppercase">Plan 70</h6>
                                    <p class="description mt-3">Navega con una velocidad de 6 Mbps por la red.</p>
                                    <div>
                                        <badge type="success" rounded>velocidad</badge>
                                        <badge type="success" rounded>seguridad</badge>
                                        <badge type="success" rounded>disponibilidad</badge>
                                    </div>
                            ...
                            <div class="col-lg-4">
                                <card class="border-0" hover shadow body-classes="py-5">
                                    ...
                                    <h6 class="text-warning text-uppercase">Plan 110</h6>
                                    <p class="description mt-3">Navega con una velocidad de 14 Mbps por la red.</p>
                                    <div>
                                        <badge type="warning" rounded>velocidad</badge>
                                        <badge type="warning" rounded>seguridad</badge>
                                        <badge type="warning" rounded>disponibilidad</badge>
                                    </div>
                            ...
                            <ul class="list-unstyled mt-5">
                                <li class="py-2">
                                    <div class="d-flex align-items-center">
                                        <badge type="success" circle class="mr-3" icon="ni ni-air-baloon"></badge>
                                        <h6 class="mb-0">Innovación</h6>
                                    </div>
                                </li>
                                <li class="py-2">
                                    <div class="d-flex align-items-center">
                                        <badge type="success" circle class="mr-3" icon="ni ni-tie-bow"></badge>
                                        <h6 class="mb-0">Confiabilidad</h6>
                                    </div>
                                </li>
                                <li class="py-2">
                                    <div class="d-flex align-items-center">
                                ...
                                <li class="py-2">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <h6 class="mb-0">Mejora continua</h6>
                                    </div>
                                </li>
                                <li class="py-2">
                                    <div class="d-flex align-items-center">
                                        <badge type="success" circle class="mr-3" icon="ni ni-satisfied"></badge>
                                        <h6 class="mb-0">Satisfacción de nuestros clientes</h6>
                                    </div>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="row row-grid align-items-center">
                    <div class="col-md-6">
                        <div class="card bg-default shadow border-0">
                            <img v-lazy="'img/theme/user2.jpg'" class="card-img">
                            <blockquote class="card-blockquote">
                                ...
                                <h4 class="display-3 font-weight-bold text-white">Velocidad </h4>
        ...
        <section class="section section-lg">
            <div class="container">
                <div class="row justify-content-center text-center">
                    <div class="col-lg-8">
                        <h2 class="display-3">Nuestros Planes</h2>
                        <p class="lead text-muted">Navega con la velocidad que mas te guste.</p>                            
                    </div>
                </div>
                <div class="row">
                    <div class="container pt-lg pb-300">
                        <div class="row row-grid mt-5">
                            <div class="col-lg-4">
                                <icon name="ni ni-settings" size="lg" gradient="black" shadow round color="primary"></icon>
                                <h5 class="text-black mt-3">Plan 40</h5>
                                <p class="text-black mt-3">Some quick example text to build on the card title and make up the
                                bulk of the card's content.</p>
                            </div>
                            <div class="col-lg-4">
                                <icon name="ni ni-ruler-pencil" size="lg" gradient="black" shadow round color="primary"></icon>
                                <h5 class="text-black mt-3">Plan 60</h5>
                                <p class="text-black mt-3">Some quick example text to build on the card title and make up the
                                bulk of the card's content.</p>
                            </div>
                            <div class="col-lg-4">
                                <icon name="ni ni-atom" size="lg" gradient="black" shadow round color="primary"></icon>
                                <h5 class="text-black mt-3">Plan 70</h5>
                                <p class="text-black mt-3">Some quick example text to build on the card title and make up the
                                bulk of the card's content.</p>
                            </div>                            
                            <div class="col-lg-12">
                            ...
                            <div class="col-lg-4">
                                <icon name="ni ni-settings" size="lg" gradient="black" shadow round color="primary"></icon>
                                <h5 class="text-black mt-3">Plan 90</h5>
                                <p class="text-black mt-3">Some quick example text to build on the card title and make up the
                                bulk of the card's content.</p>
                            </div>
                            <div class="col-lg-4">
                                <icon name="ni ni-ruler-pencil" size="lg" gradient="black" shadow round color="primary"></icon>
                                <h5 class="text-black mt-3">Plan 110</h5>
                                <p class="text-black mt-3">Some quick example text to build on the card title and make up the
                                bulk of the card's content.</p>
                            </div>
                            <div class="col-lg-2"></div>
